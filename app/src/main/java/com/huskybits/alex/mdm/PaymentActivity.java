...
public class PaymentActivity extends Activity{
    ...
    //private static final String CONFIG_CLIENT_ID = "ATRvIkvQzAqGRTAaTRLBRm8BrtGziPJx4dbMMuGiPi3XL9fgFS5jvc4QOQ2thR1vPnT_V0J7GI62hjGy";  // Production
    private static final String CONFIG_CLIENT_ID = "AXmEaG3Tt2eSCPaISEci8xGUSowSNOZjq70_cV3fq3ShTPFoMbEYhGlowcEKtq9VvRPbYM1OzGOHeIC8";  // Sandbox
    ...
    private static PayPalConfiguration config = new PayPalConfiguration()
            ...
            .merchantName("Late Night Engineers")
    ...
    private PayPalPayment getThingToBuy(String paymentIntent) {
        return new PayPalPayment(new BigDecimal("1.0"), "EUR", "drink",
                paymentIntent);
    }
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (confirm != null) {
                    try {
                        ...
                        Intent i = new Intent(getApplicationContext(), GenerateQRCodeActivity.class);
                        startActivity(i);
